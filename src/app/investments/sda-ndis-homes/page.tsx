...
export default function SdaNdisHomesPage() {
 ...
 <LeadLink href="/contact?type=sda-ndis-homes" className="btn-primary text-base px-7 py-4">
 ...
 <p className="text-2xl font-black" style={{ color: "#DC2626", fontFamily: "var(--font-display)" }}>8–15%+</p>
