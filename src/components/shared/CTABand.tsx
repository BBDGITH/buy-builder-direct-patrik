...
export default function CTABand({ serviceName, slug }: CTABandProps) {
 ...
 Speak with a BBD specialist and discover exactly how much you can save by going direct. No
 agent, no markup — just a straight conversation about your investment goals.
 </p>
 ...
 No spam. No pressure. BBD is remunerated by builders — not investors.
 </p>
 </div>
 </section>
 );
