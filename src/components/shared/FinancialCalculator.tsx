...
export default function FinancialCalculator({ showCta = true }: { showCta?: boolean }) {
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="p-6 md:p-8 flex flex-col gap-7 md:border-r"
          style={{ borderColor: "rgba(255,255,255,0.06)" }}
        >
          <div>
            <h3
            ...
            <div className="flex justify-between text-sm font-medium">
              ...
              <span style={{ color: "#22C55E" }}>
                {formatAud(r.totalAnnualRent)}/yr
              </span>
            </div>
          </div>
          ...
          <div className="flex justify-between items-center text-sm font-semibold">
            ...
            <span style={{ color: "#22C55E" }}>
              + {formatAud(r.netRentalIncome)} / yr
            </span>
          </div>
          ...
          >
            ...
            <p className="text-xs mb-3" style={{ color: "#666" }}>
              Loan {formatAud(r.loanAmount)} · {interestRate.toFixed(2)}% p.a. ·{" "}
              {DEFAULTS.loanTermYears}yr P&amp;I
            </p>
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(160deg, #1a0505 0%, #2a0a0a 40%, #0A0A0A 100%)",
          }}
        >
          <div>
            ...
            >
              ...
              {formatAud(r.depreciationRefund)} at{" "}
              {(DEFAULTS.marginalTaxRate * 100).toFixed(0)}% marginal rate
            </p>
            ...
            <p
              ...
              style={{
                color:
                  r.finalTakeaway >= 0 ? "#FFFFFF" : "#F87171",
          ...
          >
            ...
            >
              ...
              <div className="flex justify-between gap-4">
                <span>
                  Depreciation refund (
                  {formatAud(r.depreciationDeduction)} ×{" "}
                  {(DEFAULTS.marginalTaxRate * 100).toFixed(0)}%)
                </span>

                <span style={{ color: "#22C55E" }}>
                  + {formatAud(r.depreciationRefund)}
                </span>
              </div>
            ...
            <p
              ...
              style={{ color: "#666" }}
            >
              Illustrative only. This calculator produces modelled figures based on the inputs and default assumptions shown, not a forecast or a quote. It does not take into account your objectives, financial situation or needs. Obtain independent financial, tax and legal advice before making any investment decision.
            </p>
          </div>
        </div>
      </div>
